    ...
    <div class="w-full xla:w-[70%]">
        ...
        <div class="mt-2 border-b-2 pb-4">
            ...
            <ul class="ml-10 list-disc text-sm lga:text-lg">
                ...
                <li>Secretary: <strong>Haviluddin</strong>, Assist. Prof., Ph.D. | <strong>Nia Fitria</strong>, SM., BBA
                </li>
                <li>Treasurer: <strong>Intan Tri Wahyuningtyas,</strong> AS.</li>
                <li>
                    <h6>Members: </h6>
                    <ul class="ml-12 list-[circle]">
                        <li>Publication Director: <strong>Andri Pranolo</strong>, Assist. Prof., S.Kom., M.</li>
                        <li>Research and development Director: <strong>Silvia Santi</strong> | <strong>Adhi
                                Prahara</strong>,
                            Assist. Prof., M.Cs. | <strong>Supriyanto</strong>, Assist. Prof., M.Eng.</li>
                        <li>Public Relation Director: <strong>Tuti Purwaningsing</strong>, Assist. Prof., M.Stats. |
                            <strong>Rifky
                                Dora Wijayanti</strong>, Assist. Prof. , M.Sc.
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <ul class="ml-8 mt-2 list-disc">
                ...
                <li>
                    ...
                    <ul class="ml-10 list-decimal lga:text-lg text-sm">
                        ...
                        <li>Aieman Ahmad Al-Omari, Professor., Ph.D.</li>
                        <li>Ramlee Mustapha, Prof., Ph.D.</li>
                        <li>Mahendran Maniam, Assoc. Prof.</li>
                        <li>Shazia Malik, Dr.</li>
                        <li>Godlove Ellioth Kiswaga.</li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="ml-10 list-decimal lga:text-lg text-sm">
                        ...
                        <li>Estrella T Arroyo, Prof., Ph.D.</li>
                        <li>Georgios Tsourvakas, Assoc. Prof., PhD. </li>
                        <li>Padmakumar K, Assoc. Prof., PhD. </li>
                        <li>Abd El-Basit Ahmed Hashem Mahmoud, Assoc. Prof., PhD. </li>
                        <li>Muhammad Najih Farihanto, Assist. Prof. </li>
                        <li>Sherif Farouk Badran, Assist. Prof., Dr.</li>
                        <li>Sardar Ahmad Nazish, Assist. Prof., PhD.</li>
                        <li>Kevin Naidoo, Dr.</li>
                        <li>Tran Thi Ai Van</li>
                        <li>McMillan Mavuto Jere</li>
                        <li>Dong Hao</li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="ml-10 list-decimal lga:text-lg text-sm">
                        ...
                        <li>Andari Wuri Astuti, S.SiT., MPH., Ph.D. </li>
                    </ul>
                </li>
            </ul>
        </div>
