            ...
            <h2 class="mb-4 text-xl font-semibold lga:text-3xl">Events</>
                <div class="mt-4">
                    <div class="flex flex-col gap-2 lga:gap-4">
                        @foreach ($pagedEvents as $index => $events)
                            <div class="flex w-full flex-col items-center gap-6 border-b-2 pb-4 lga:flex-row">
                                <div class="flex max-w-[30vw] justify-center lga:aspect-video lga:max-w-[213px]">
                                    <img src="{{ $events['image'] }}" alt="" class="lga:max-h-full lga:w-auto">
                                </div>
                                <div class="p-2">
                                    ...
                                    <div class="mt-1 flex items-center gap-6 lga:mt-2">
                                        <a href="/events/read/{{ ($currentPage - 1) * 10 + $index + 1 }}"
                                            class="mt-2 flex items-center gap-6 fill-[--var-highlight] text-[--var-highlight] hover:fill-[--var-darkyellow] hover:text-[--var-darkyellow]">
                    ...
                    <div class="mt-4 flex justify-center gap-4 text-base">
                        ...
                        @if ($currentPage > 1)
                            <a href="{{ url('events/' . ($currentPage - 1)) }}"
                                class="flex h-8 w-8 items-center justify-center rounded-md border-2 text-[--var-highlight]">
